...
var editPolicy = function (pe, ps, userId, serviceId, access, request, res) {
    ...
    if (policy.matched.length > 0) {
        ...
        // check if target contains the friends generi URI or a bag
        ...
        // new user, add policy
        var policy = ps.createPolicy('p_' + userId + '_' + date, 'first-applicable', userId + '-policy');
        var subject = {};
