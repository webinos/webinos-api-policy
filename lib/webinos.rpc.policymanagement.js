...
(function () {
    ...
    PolicyManagementModule.prototype.testPolicy = function (params, successCallback, errorCallback) {
        /*if (params[2]) {
            //console.log("[webinos.rpc.policymanagement]PATH PARAM: "+JSON.stringify(params[2]));
            implModule.testPolicy(params[0]
            , params[1]
            , function (prop) {
                successCallback(prop);
            }
...
*/
    ...
    PolicyManagementModule.prototype.testNewPolicy = function (params, successCallback, errorCallback) {
        implModule.testNewPolicy(params[0]
            , params[1]
            , function (prop) {
                successCallback(prop);
            }
